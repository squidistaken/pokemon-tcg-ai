...
class RawCard:
    ...
    ``set_code`` and ``number`` are optional because some sources (wiki pages,
    loose text) only give a name and count.
    """
    ...
    category: str | None = None  # "pokemon" | "trainer" | "energy" if the source groups them
...
class RawDeck:
    ...
    source: str  # e.g. "limitless", "bulbapedia", "text"
